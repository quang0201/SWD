...
function Food() {
    ...
    const fetchData = async () => {
        try {
            const response = await fetch(`/api/food/pagging-food?index=${currentPage}&pageSize=${itemsPerPage}`);
            ...
            <section className="food_section layout_padding">
                <div className="container">
                    ...
                    <ul className="filters_menu">
                        <li data-filter=".burger"><Link to="/room">Phòng</Link></li>
                        <li data-filter=".burger"><Link to="/decor">Trang trí</Link></li>
                        <li data-filter="active"><Link to="/food">Thức ăn & Đồ uống</Link></li>
                    </ul>
                    <div>
